...
with tab1:
    ...
    image = Image.open('/home/explore-student/s3-drive/Data/capetown_.png')
...
with tab2:
    ...
    image2 = Image.open('/home/explore-student/s3-drive/Data/cape.png')
    st.image(image2, caption='Distribution of Potential Competitors in Cape Town', width=None)

with tab3:
    st.subheader("The Roadmap")

    image3 = Image.open('/home/explore-student/s3-drive/Data/27_roadmap.png')
